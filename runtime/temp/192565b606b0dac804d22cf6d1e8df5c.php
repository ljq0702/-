<?php /*a:1:{s:69:"F:\PHPWAMP\wwwroot\tp5.1\wenjuan\application\admin\view\index\wj.html";i:1588584248;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="text-right"><button type="button" class="btn btn-w-m btn-success" style="width: 100px;height: 80px" onclick="window.history.go(-1)">返回用户列表</button></div>
